...
(0, _ava.default)('method `checkIfKeysExists` exists', function (t) {
...
(0, _ava.default)('method `checkIfKeysExists` is a function', function (t) {
  t.is(typeof _utils.checkIfKeysExists === "undefined" ? "undefined" : _typeof(checkIfKeysExists), 'function');
});
(0, _ava.default)('return `false` when `checkIfKeysExists(obj, ["a", "b", "c"])`', function (t) {
  var obj = {
    a: 1,
    b: 2,
    c: 3
...
(0, _ava.default)('return `["d"]` when `checkIfKeysExists(obj, ["d"])`', function (t) {
  var obj = {
    a: 1,
    b: 2,
    c: 3
...
//# sourceMappingURL=/home/tchaguitos/Documentos/projects/correios-rest/node_modules/.cache/ava/366f007191a8d47c8f3a95ac9e5ffee5.js.map