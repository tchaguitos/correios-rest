...
(0, _ava2.default)('method `checkIfKeysExists` exists', function (t) {
  var _rec = new _powerAssertRecorder();

  t.truthy(_rec._expr(_rec._capt(_utils.checkIfKeysExists, "arguments/0"), {
    content: "t.truthy(checkIfKeysExists)",
    filepath: "test/unit/utils/error/checkIfKeysExists.test.js",
    line: 8,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"truthy\",\"range\":[2,8]},\"computed\":false,\"range\":[0,8]},\"arguments\":[{\"type\":\"Identifier\",\"name\":\"checkIfKeysExists\",\"range\":[9,26]}],\"range\":[0,27]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"name\"},\"value\":\"truthy\",\"range\":[2,8]},{\"type\":{\"label\":\"(\"},\"range\":[8,9]},{\"type\":{\"label\":\"name\"},\"value\":\"checkIfKeysExists\",\"range\":[9,26]},{\"type\":{\"label\":\")\"},\"range\":[26,27]}]",
    visitorKeys: _powerAssertVisitorKeys
  }));
});
(0, _ava2.default)('method `checkIfKeysExists` is a function', function (t) {
  t.is(typeof _utils.checkIfKeysExists === "undefined" ? "undefined" : _typeof(_utils.checkIfKeysExists), 'function');
});
(0, _ava2.default)('return `false` when `checkIfKeysExists(obj, ["a", "b", "c"])`', function (t) {
  var obj = {
    a: 1,
    b: 2,
    c: 3
  };
  var result = (0, _utils.checkIfKeysExists)(obj, ['a', 'b', 'c']);
  t.deepEqual(result, false);
});
(0, _ava2.default)('return `["d"]` when `checkIfKeysExists(obj, ["d"])`', function (t) {
  var obj = {
    a: 1,
    b: 2,
    c: 3
  };
  var result = (0, _utils.checkIfKeysExists)(obj, ['d']);
  t.deepEqual(result, ['d']);
});
//# sourceMappingURL=/home/tchaguitos/Documentos/projects/correios-rest/node_modules/.cache/ava/451a2e3f12883e331c9cfc674fd9a3a9.js.map