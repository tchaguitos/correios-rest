...
(0, _ava2.default)('method `replaceBrackets` exists', function (t) {
  var _rec = new _powerAssertRecorder();

  t.truthy(_rec._expr(_rec._capt(_utils.replaceBrackets, "arguments/0"), {
    content: "t.truthy(replaceBrackets)",
    filepath: "test/unit/utils/string/replaceBrackets.test.js",
    line: 8,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"truthy\",\"range\":[2,8]},\"computed\":false,\"range\":[0,8]},\"arguments\":[{\"type\":\"Identifier\",\"name\":\"replaceBrackets\",\"range\":[9,24]}],\"range\":[0,25]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"name\"},\"value\":\"truthy\",\"range\":[2,8]},{\"type\":{\"label\":\"(\"},\"range\":[8,9]},{\"type\":{\"label\":\"name\"},\"value\":\"replaceBrackets\",\"range\":[9,24]},{\"type\":{\"label\":\")\"},\"range\":[24,25]}]",
    visitorKeys: _powerAssertVisitorKeys
  }));
});
(0, _ava2.default)('method `replaceBrackets` is a function', function (t) {
  t.is(typeof _utils.replaceBrackets === "undefined" ? "undefined" : _typeof(_utils.replaceBrackets), 'function');
});
(0, _ava2.default)('return `abcde` when `replaceBrackets("a[b]c[]de")`', function (t) {
  var result = (0, _utils.replaceBrackets)('a[b]c[]de');
  t.is(result, 'abcde');
});
//# sourceMappingURL=/home/tchaguitos/Documentos/projects/correios-rest/node_modules/.cache/ava/51e4a298f68a581e16aa0a52d7f7703e.js.map