...
var _sinonStubPromise = _interopRequireDefault(require("sinon-stub-promise"));
...
(0, _sinonStubPromise.default)(_sinon.default);
(0, _ava.default)('method `makeRequest` exists', function (t) {
  var _rec = new _powerAssertRecorder();

  t.truthy(_rec._expr(_rec._capt(_utils.makeRequest, "arguments/0"), {
    content: "t.truthy(makeRequest)",
    filepath: "test/unit/utils/request/makeRequest.test.js",
    line: 13,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"truthy\",\"range\":[2,8]},\"computed\":false,\"range\":[0,8]},\"arguments\":[{\"type\":\"Identifier\",\"name\":\"makeRequest\",\"range\":[9,20]}],\"range\":[0,21]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"name\"},\"value\":\"truthy\",\"range\":[2,8]},{\"type\":{\"label\":\"(\"},\"range\":[8,9]},{\"type\":{\"label\":\"name\"},\"value\":\"makeRequest\",\"range\":[9,20]},{\"type\":{\"label\":\")\"},\"range\":[20,21]}]",
    visitorKeys: _powerAssertVisitorKeys
  }));
});
(0, _ava.default)('method `makeRequest` is a function', function (t) {
  t.is(typeof _utils.makeRequest === "undefined" ? "undefined" : _typeof(makeRequest), 'function');
});
//# sourceMappingURL=/home/tchaguitos/Documentos/projects/correios-rest/node_modules/.cache/ava/6dd93291bc24bbeef0514497d4e38617.js.map