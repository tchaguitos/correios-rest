...
(0, _ava2.default)('method `checkIfKeysExists` exists', function (t) {
  ...
  t.truthy(_rec._expr(_rec._capt(_utils.mountErrorMessage, "arguments/0"), {
    content: "t.truthy(mountErrorMessage)",
    filepath: "test/unit/utils/error/mountErrorMessage.test.js",
    line: 8,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"truthy\",\"range\":[2,8]},\"computed\":false,\"range\":[0,8]},\"arguments\":[{\"type\":\"Identifier\",\"name\":\"mountErrorMessage\",\"range\":[9,26]}],\"range\":[0,27]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"name\"},\"value\":\"truthy\",\"range\":[2,8]},{\"type\":{\"label\":\"(\"},\"range\":[8,9]},{\"type\":{\"label\":\"name\"},\"value\":\"mountErrorMessage\",\"range\":[9,26]},{\"type\":{\"label\":\")\"},\"range\":[26,27]}]",
    visitorKeys: _powerAssertVisitorKeys
  }));
});
(0, _ava2.default)('method `mountErrorMessage` is a function', function (t) {
  t.is(typeof _utils.mountErrorMessage === "undefined" ? "undefined" : _typeof(_utils.mountErrorMessage), 'function');
});
(0, _ava2.default)('return `["a is required", "b is required"]` when `mountErrorMessage(["a", "b"])`', function (t) {
  var result = (0, _utils.mountErrorMessage)(['a', 'b']);
  t.deepEqual(result, ['a is required', 'b is required']);
});
//# sourceMappingURL=/home/tchaguitos/Documentos/projects/correios-rest/node_modules/.cache/ava/83890434356d1eb6975f536f83ff11aa.js.map