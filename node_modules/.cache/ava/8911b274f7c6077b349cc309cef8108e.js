...
(0, _ava.default)('method `mountErrorMessage` is a function', function (t) {
  t.is(typeof _utils.mountErrorMessage === "undefined" ? "undefined" : _typeof(mountErrorMessage), 'function');
});
(0, _ava.default)('return `["a is required", "b is required"]` when `mountErrorMessage(["a", "b"])`', function (t) {
  var result = (0, _utils.mountErrorMessage)(['a', 'b']);
  t.deepEqual(result, ['a is required', 'b is required']);
});
//# sourceMappingURL=/home/tchaguitos/Documentos/projects/correios-rest/node_modules/.cache/ava/8911b274f7c6077b349cc309cef8108e.js.map