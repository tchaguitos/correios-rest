...
function _typeof(obj) { if (typeof Symbol === "function" && _typeof(Symbol.iterator) === "symbol") { _typeof = function (_typeof2) { function _typeof(_x2) { return _typeof2.apply(this, arguments); } _typeof.toString = function () { return _typeof2.toString(); }; return _typeof; }(function (obj) { return typeof obj === "undefined" ? "undefined" : _typeof(obj); }); } else { _typeof = function (_typeof3) { function _typeof(_x3) { return _typeof3.apply(this, arguments); } _typeof.toString = function () { return _typeof3.toString(); }; return _typeof; }(function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj === "undefined" ? "undefined" : _typeof(obj); }); } return _typeof(obj); }

(0, _ava2.default)('method `parseResponse` exists', function (t) {
  var _rec = new _powerAssertRecorder();

  t.truthy(_rec._expr(_rec._capt(_utils.parseResponse, "arguments/0"), {
    content: "t.truthy(parseResponse)",
    filepath: "test/unit/utils/response/parseResponse.test.js",
    line: 8,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"truthy\",\"range\":[2,8]},\"computed\":false,\"range\":[0,8]},\"arguments\":[{\"type\":\"Identifier\",\"name\":\"parseResponse\",\"range\":[9,22]}],\"range\":[0,23]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"name\"},\"value\":\"truthy\",\"range\":[2,8]},{\"type\":{\"label\":\"(\"},\"range\":[8,9]},{\"type\":{\"label\":\"name\"},\"value\":\"parseResponse\",\"range\":[9,22]},{\"type\":{\"label\":\")\"},\"range\":[22,23]}]",
    visitorKeys: _powerAssertVisitorKeys
  }));
});
(0, _ava2.default)('method `parseResponse` is a function', function (t) {
  t.is(typeof _utils.parseResponse === "undefined" ? "undefined" : _typeof(_utils.parseResponse), 'function');
});
(0, _ava2.default)('result is an object', function (t) {
  var result = (0, _utils.parseResponse)("\n    <?xml version=\"1.0\" encoding=\"utf-8\"?>\n    <cResultado\n    xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"\n    xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"\n    xmlns=\"http://tempuri.org/\">\n    <Servicos>\n    <cServico>\n    <Codigo>40010</Codigo>\n    <Valor>49,62</Valor>\n    <ValorMaoPropria>0,00</ValorMaoPropria>\n    <ValorAvisoRecebimento>0,00</ValorAvisoRecebimento>\n    <ValorValorDeclarado>1,22</ValorValorDeclarado>\n    <Erro />\n    <MsgErro />\n    <ValorSemAdicionais>48,40</ValorSemAdicionais>\n    </cServico>\n    </Servicos>\n    </cResultado>");
  t.is(typeof result === "undefined" ? "undefined" : _typeof(result), 'object');
});
(0, _ava2.default)('method `parseResponse` return the correct data', function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(t) {
    var xml, result, responseMock;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            xml = "\n    <?xml version=\"1.0\" encoding=\"utf-8\"?>\n    <cResultado\n    xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"\n    xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"\n    xmlns=\"http://tempuri.org/\">\n    <Servicos>\n    <cServico>\n    <Codigo>40010</Codigo>\n    <Valor>49,62</Valor>\n    <ValorMaoPropria>0,00</ValorMaoPropria>\n    <ValorAvisoRecebimento>0,00</ValorAvisoRecebimento>\n    <ValorValorDeclarado>1,22</ValorValorDeclarado>\n    <Erro />\n    <MsgErro />\n    <ValorSemAdicionais>48,40</ValorSemAdicionais>\n    </cServico>\n    </Servicos>\n    </cResultado>";
            _context.next = 3;
            return (0, _utils.parseResponse)(xml);
...
//# sourceMappingURL=/home/tchaguitos/Documentos/projects/correios-rest/node_modules/.cache/ava/8f128197dc5a0f345f09af2650377341.js.map