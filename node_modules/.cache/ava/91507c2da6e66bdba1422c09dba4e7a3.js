...
(0, _ava.default)('method `replaceBrackets` exists', function (t) {
...
(0, _ava.default)('method `replaceBrackets` is a function', function (t) {
  t.is(typeof _utils.replaceBrackets === "undefined" ? "undefined" : _typeof(replaceBrackets), 'function');
});
(0, _ava.default)('return `abcde` when `replaceBrackets("a[b]c[]de")`', function (t) {
  var result = (0, _utils.replaceBrackets)('a[b]c[]de');
  t.is(result, 'abcde');
});
//# sourceMappingURL=/home/tchaguitos/Documentos/projects/correios-rest/node_modules/.cache/ava/91507c2da6e66bdba1422c09dba4e7a3.js.map