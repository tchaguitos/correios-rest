...
(0, _ava.default)('method `mountSearchParams` exists', function (t) {
  var _rec = new _powerAssertRecorder();

  t.truthy(_rec._expr(_rec._capt(_utils.mountSearchParams, "arguments/0"), {
    content: "t.truthy(mountSearchParams)",
    filepath: "test/unit/utils/request/mountSearchParams.test.js",
    line: 8,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"truthy\",\"range\":[2,8]},\"computed\":false,\"range\":[0,8]},\"arguments\":[{\"type\":\"Identifier\",\"name\":\"mountSearchParams\",\"range\":[9,26]}],\"range\":[0,27]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"name\"},\"value\":\"truthy\",\"range\":[2,8]},{\"type\":{\"label\":\"(\"},\"range\":[8,9]},{\"type\":{\"label\":\"name\"},\"value\":\"mountSearchParams\",\"range\":[9,26]},{\"type\":{\"label\":\")\"},\"range\":[26,27]}]",
    visitorKeys: _powerAssertVisitorKeys
  }));
});
(0, _ava.default)('method `mountSearchParams` is a function', function (t) {
  t.is(typeof _utils.mountSearchParams === "undefined" ? "undefined" : _typeof(mountSearchParams), 'function');
});
(0, _ava.default)('return `a=a&b=b&c=c` when `mountSearchParams({a: "a", b: "b", c: "c"})`', function (t) {
  var result = (0, _utils.mountSearchParams)({
    a: 'a',
    b: 'b',
    c: 'c'
  });
...
//# sourceMappingURL=/home/tchaguitos/Documentos/projects/correios-rest/node_modules/.cache/ava/9d30fc89707c06ab6298af10aff199af.js.map